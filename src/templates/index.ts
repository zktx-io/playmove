...
export const TEMPLATES_INTRO: MoveTemplate[] = [
...
export const TEMPLATES_MYSTEN: MoveTemplate[] = [
...
export const TEMPLATES: MoveTemplate[] = [
  ...TEMPLATES_INTRO,
  ...TEMPLATES_MYSTEN,
];

/** Look up a template by id, fallback to first */
export function getTemplate(id: string): MoveTemplate {
